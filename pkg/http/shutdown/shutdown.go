...
//
// You can provide anything that implements Callback interface,
...
// is encountered in Callback or in ShutdownManager.
//
...
// first call ShutdownStart on Shutdown manager,
